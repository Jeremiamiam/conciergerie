        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li><Link href="/location/lacabane" className="hover:text-white">La Cabane</Link></li>
                <li><Link href="/location/arkea" className="hover:text-white">Arkea</Link></li>
                <li><Link href="/location/pei" className="hover:text-white">PEI</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <address className="text-gray-400 not-italic">
                <p>12 Rue des Conciergeries, 35000 Rennes</p>
                <p className="mt-2">02 XX XX XX XX</p>
                <p className="mt-2">contact@lesconciergeriesrennaises.fr</p>
              </address>
            </div>
          </div>
